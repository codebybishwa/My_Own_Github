...
class Planet:
    ...
    def attraction(self, other):
        ...
        # Calculate the force and it's components
    ...
    def update_position(self, planets):
        ...
        # Update velocity (acceleration = F / m  => v/t = F/m => v = F/m * t)
        self.x_vel += total_fx / self.mass * self.TIMESTEP
        self.y_vel += total_fy / self.mass * self.TIMESTEP

        # Note: This is not the accurate instataneous velocity but the velocity change in a day

        # Update position based on velocity  (d = v x t)
